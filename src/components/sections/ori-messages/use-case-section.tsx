	...
	return (
		<div className="flex items-center justify-center gap-2.5">
			<svg
				className="w-9 h-9 sm:w-11 sm:h-11 shrink-0"
				viewBox="0 0 24 24"
				fill="url(#ig-use-case-gradient)"
				aria-hidden
			>
				<defs>
					<linearGradient
						id="ig-use-case-gradient"
						x1="0%"
						y1="100%"
						x2="100%"
						y2="0%"
					...
					{CARDS.map((card, i) => (
						...
						>
							...
							<div className="bg-background dark:bg-dark-elevated rounded-3xl shadow-card flex flex-col">
								...
								{/* Video */}
								<video
									className="mx-6 mb-8 rounded-2xl w-[calc(100%-3rem)] object-cover"
									src={
							...
							{/* Caption */}
							<p className="font-display font-semibold text-base sm:text-lg text-text-secondary dark:text-text-tertiary text-center px-2">
								{card.caption}
							</p>
						</motion.div>
					))}
