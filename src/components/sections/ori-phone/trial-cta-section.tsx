...
export function TrialCTASection() {
	...
	return (
		<motion.section
			id="trial"
			className="relative overflow-hidden bg-background-secondary dark:bg-dark-surface py-12 xs:py-12 my-12 xs:my-12 md:py-24 px-5 md:px-10 text-center"
		>
			{/* Ambient lights */}
			<div
				aria-hidden
			...
			<div className="relative max-w-4xl mx-auto flex flex-col items-center gap-5 sm:gap-6">
				...
				<motion.h2
					...
					className="font-display font-bold text-3xl sm:text-4xl lg:text-4xl text-text-primary dark:text-text leading-tight 3xl:text-5xl"
				>
					{trialCta.title1}{" "}
				...
				<motion.p
					...
					className="font-display font-semibold text-base xs:text-lg md:text-lg lg:text-2xl text-text-primary dark:text-text max-w-2xl"
				>
					{trialCta.subtitle}
				</motion.p>
