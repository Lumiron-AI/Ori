...
const CARDS: AudioCardProps[] = [
	{
		...
		tagGroups: [
			...
			{ at: 20, tags: ["Client identifié via numéro", "Préférence « table au calme » confirmée"] },
	...
	},
	{
		...
		tagGroups: [
			...
			{ at: 18, tags: ["Demande anniversaire qualifiée (15 pers)", "Formules groupe envoyées par SMS"] },
...
export function UseCaseSection() {
	...
	return (
		<motion.section id="use-case" ref={ref} style={{ opacity }} className="bg-background dark:bg-dark-bg py-20 px-5">
			<div className="max-w-8xl lg:max-w-9xl mx-auto">
				...
				<p className="font-display font-normal text-lg text-text-secondary dark:text-text-tertiary text-center mt-12 max-w-3xl mx-auto">
