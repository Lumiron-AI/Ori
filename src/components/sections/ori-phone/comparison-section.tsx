	...
	return (
		...
		>
			<div className="max-w-8xl lg:max-w-9xl mx-auto">
				...
				<p className="font-display font-normal text-sm sm:text-base text-text-secondary dark:text-text-tertiary text-center mt-8 max-w-3xl mx-auto whitespace-pre-line">
					{comparison.footer}
				</p>
			</div>
		</motion.section>
