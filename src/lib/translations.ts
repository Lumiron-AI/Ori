		...
		cgv: {
			...
			sections: [
				...
				},
				{
					...
					referrerItems: ["200 minutes ou 200 discussions offertes (selon le plan du filleul)"],
					referredLabel: "Pour le filleul",
					referredItems: ["200 minutes ou 200 discussions offertes (selon son plan)"],
					conditionsIntro: "Conditions :",
					conditions: [
		...
		cgv: {
			...
			sections: [
				...
				},
				{
					...
					referrerItems: ["200 free minutes or 200 free conversations (based on the referred client's plan)"],
					referredLabel: "For the referred client",
					referredItems: ["200 free minutes or 200 free conversations (based on their plan)"],
					conditionsIntro: "Conditions:",
					conditions: [
